...
import { EnumTipoComprobanteProvider } from "@interfaces/enum";
...
const list: ListItem[] = [
  {
    id: 1,
    name: EnumTipoComprobanteProvider.DECLARADO,
  },
  {
    id: 2,
    name: EnumTipoComprobanteProvider.NODECLARADO,
  },
];
...
const AutocompleteTipoComprobanteProvider: React.FunctionComponent<
  ButtonProps
> = (props) => {
...
export default AutocompleteTipoComprobanteProvider;
