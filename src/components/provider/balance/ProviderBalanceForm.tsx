...
import { AutocompleteFormaPagoProvider } from "@components/common/autocomplete";
...
const ProviderBalanceForm: React.FunctionComponent<ProviderAccountProps> = (
  ...
  const validateField = () => {
    ...
    if (!formData.tipoPago || formData.tipoPago.trim() === "") {
      errorControl.fieldError = "Forma de pago is required";
      errorControl.messageError = "Seleccione el forma de pago";
  ...
  const handleSelectFormaPago = (value: string) => {
    formData.tipoPago = value;
  };
