...
function HeaderComponent() {
  ...
  useEffect(() => {
    logger.info(`Header: Rendering decision - isMobile: ${isMobile}, isAuthenticated: ${isAuthenticated}`);
    if (!isMobile && !isAuthenticated) {
      logger.warn("Header: Showing unauthenticated desktop header (session might be expired)");
    }
